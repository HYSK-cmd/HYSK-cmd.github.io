/* work.js
   ...
   appear in the carousel:
     ...
     fit    how much of the frame this scene fills, 1 = the default. The
            scenes are not all the same shape — the trajectory helix is
            small and central, the task stack is tall and narrow — so this
            evens them out against each other. Every scene is projected at
            the one zoom in core.js; this is the only per-scene framing.
  ...
  const WORK = [
    {
      ...
      hue: "#8ab4f8",
      draw: glyphAgents, yaw: 0.62, pitch: 0.22, fit: 1.14,
    ...
    },
    {
      ...
      hue: "#8ab4f8",
      draw: glyphHub, yaw: 0.55, pitch: -0.22, fit: 1.34,
    ...
    },
    {
      ...
      hue: "#5ad1c4",
      draw: glyphTrajectory, yaw: 0.70, pitch: 0.30, fit: 1.45,
    ...
    },
    {
      ...
      hue: "#e878b4",
      draw: glyphCamera, yaw: 0.52, pitch: -0.36, fit: 0.67,
    ...
    },
    {
      ...
      hue: "#a48cf0",
      draw: glyphSpider, yaw: 0.60, pitch: -0.34, fit: 1.09,
    ...
    },
    {
      ...
      hue: "#f0954a",
      draw: glyphTars, yaw: 0.58, pitch: -0.42, fit: 1.45,
    ...
    },
    {
      ...
      hue: "#f0c94a",
      draw: glyphTodo, yaw: 0.66, pitch: -0.40, fit: 1.24,
    ...
    },
    {
      ...
      hue: "#f0954a",
      draw: glyphDrone, yaw: 0.62, pitch: -0.30, fit: 1.06,
